...
!!! abstract "Roteiro completo de transformação — Titanic (em português)"
    ...
    [:material-file-document-outline: abrir o roteiro](https://htmlpreview.github.io/?https://raw.githubusercontent.com/hsandmann/biblio/refs/heads/main/material/handouts/handout-normalizacao-titanic.html){:target="_blank"}
